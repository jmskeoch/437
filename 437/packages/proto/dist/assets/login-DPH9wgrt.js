import{i as m,x as d,b as l,d as f,a as b}from"./lit-element-C8xrrTpq.js";import{r as p,n as u}from"./state-Cbw7rNgx.js";import{r as g}from"./reset.css-CX6WKRa3.js";var v=Object.defineProperty,i=(h,r,t,o)=>{for(var e=void 0,a=h.length-1,c;a>=0;a--)(c=h[a])&&(e=c(r,t,e)||e);return e&&v(r,t,e),e};const n=class n extends m{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password)}render(){return d`
      <form
